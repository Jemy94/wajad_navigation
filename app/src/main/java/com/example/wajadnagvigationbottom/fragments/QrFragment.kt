...
class QrFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    (activity as MainActivity).home_button.setOnClickListener {
      naveController.navigate(R.id.action_thirdFragment_to_firstFragment)
    }

    (activity as MainActivity).notification.setOnClickListener {
      naveController.navigate(R.id.action_thirdFragment_to_secondFragment)
    }

    (activity as MainActivity).profile.setOnClickListener {
      naveController.navigate(R.id.action_thirdFragment_to_fourthFragment)
    }
