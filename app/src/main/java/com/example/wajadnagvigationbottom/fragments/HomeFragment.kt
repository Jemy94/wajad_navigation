...
class HomeFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    (activity as MainActivity).qr_code.setOnClickListener {
      naveController.navigate(R.id.action_firstFragment_to_thirdFragment)
    }

    (activity as MainActivity).notification.setOnClickListener {
      naveController.navigate(R.id.action_firstFragment_to_secondFragment)
    }

    (activity as MainActivity).profile.setOnClickListener {
      naveController.navigate(R.id.action_firstFragment_to_fourthFragment2)
    }
